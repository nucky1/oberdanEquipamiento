...
public class principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.add(new Views.Inicio.Home());
        jTabbedPane1.setIconAt(0, new ImageIcon(getClass().getResource("/Statics/home.png")));
        jTabbedPane1.add(new Views.Proveedores.ProveedoresView());
        jTabbedPane1.setIconAt(1, new ImageIcon(getClass().getResource("/Statics/proveedores.png")));
        jTabbedPane1.add(new Views.Articulos.ProductosView());
        jTabbedPane1.setIconAt(2, new ImageIcon(getClass().getResource("/Statics/productos.png")));
        jTabbedPane1.add(new Views.Facturacion.Facturacion());
        jTabbedPane1.setIconAt(3, new ImageIcon(getClass().getResource("/Statics/facturacion.png")));
        jTabbedPane1.add(new Views.Remitos.Remitos());
