...
public class ClientesDAO {
    ...
    /**
     * @param rs This method is incomplete and doesn't work properly
     */
    ...
    /**
     * NOtas: en los catch pone: new Statics.ExceptionManager().saveDump(ex,
     * "aca va un obs", Main.isProduccion);
     */
    /**
     *
     * @param tipo_busqueda
    ...
    public Cliente recuperarConyugue(String idCliente) {
         ...
         * (SELECT relacion.tipo, relacion.created_at, IF(cliente1_id = 1,
         * cliente2_id,cliente1_id) as clientId FROM relacion WHERE
         * (cliente1_id=1 OR cliente2_id=1) && relacion.state= 'ACTIVO' ) AS
         * rel2 ON rel2.clientId = cliente.id ORDER BY rel2.created_at DESC
         */
     ...
     * @param c1
     * @param c2
     * @return true if succes. Is really important bring c1 and c2 in the same
     * order as they appeair in the "relacion"
     */
    ...
    /**
     * public int recuperarZona(String barrio) { String SQL = "SELECT zona FROM
     * barrio WHERE nombre ="+barrio; ResultSet rs =
